        ...
        <Sheet>
          ...
          <SheetContent side="left" className="bg-white dark:bg-gray-900">
            ...
            <div className="border-t border-gray-200 px-4 py-4 dark:border-gray-700">
              ...
              <WalletConnect className="flex w-full items-center justify-center gap-2 rounded-md px-4 py-2 text-sm font-medium transition-colors hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900" />
            </div>
          </SheetContent>
        </Sheet>
      </div>
